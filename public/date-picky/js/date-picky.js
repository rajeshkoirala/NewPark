        ...
        AppendDate = {
            ...
            setTable: function ($datePicker, _this, options) {
                ...
                if(options.disableClickEvent){
                    console.log(options.disableClickEvent);
...
//            $datePicker = AppendDate.setFooter($datePicker, _this, options);
    ...
    $.fn.datePicky = function (options) {
        ...
        if (allOptions.activation == 'always-on') {
        ...
        //Check for disable click events
//        if(allOptions.disableClickEvent){
//            debugger;
//            console.log($('.table-overlay'));
//            $(".table-overlay").css("display", "block");
//        }
    }
