...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ url('admin/privacy-and-security') }}">Privacy and Security</a></li>
...
@section('script')
<script>
    $(".sidebar-nav").find(".menu-footer").addClass('active').find('.menu-privacy-security').addClass('active');
</script>
