...
@section('breadcrumb')
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="{{ url('admin/terms-of-use') }}">Terms Of Use</a></li>
...
@section('script')
    <script>
        $(".sidebar-nav").find(".menu-footer").addClass('active').find('.menu-terms-of-use').addClass('active');
    </script>
@stop